...
export class AllRequestsManagementComponent implements OnInit,OnDestroy {
  ...
  acceptSelectedRequest(){
    ...
    this.acceptRequestServiceSubscriber= this.requests.acceptRequestByReqId(this.selectedRequestItemResult.id,this.description).subscribe(x=>{
      console.log(x)
  ...
  rejectSelectedRequest(){
   ...
   this.rejectRequestServiceSubscriber= this.requests.rejectRequestByReqId(this.selectedRequestItemResult.id,this.description).subscribe(x=>{
      console.log(x);
      this.sendDataToServer=false;
      this.refreshAllRequest();
      this.closeModal();
